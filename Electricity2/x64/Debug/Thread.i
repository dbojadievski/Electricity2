#line 1 "C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp"
...
#pragma warning(pop) 
#line 2 "C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp"
...
#line 4 "C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.h"
...
#line 3 "C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp"
...
{	
	...
	(void)( (!!(threadStart.GetWorkFunction())) || (_wassert(L"threadStart.GetWorkFunction()", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(34)), 0) );

	// A detached thread that starts suspended can never be run, as it has no handle that can be used to start it.
	(void)( (!!(!threadStart.m_bDetached || threadStart.m_bScheduled)) || (_wassert(L"!threadStart.m_bDetached || threadStart.m_bScheduled", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(37)), 0) ); 
	...
	if ( threadStart.GetWorkFunction() )
	{
		...
		if ( m_PlatformThreadID )
		{
			...
			(void)( (!!(m_pPlatformThread)) || (_wassert(L"m_pPlatformThread", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(47)), 0) );

			if ( threadStart.m_bDetached )
			{
				const bool bDetached	= PlatformThread::Detach( m_pPlatformThread );
				(void)( (!!(bDetached)) || (_wassert(L"bDetached", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(52)), 0) );
				if ( bDetached )
				{
...
CoreThread::GetExitCode() const noexcept
{
	...
	(void)( (!!(bIsRunning)) || (_wassert(L"bIsRunning", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(118)), 0) );
	if ( bIsRunning )
	{
...
{
	const bool bIsRunning	= IsRunning();
	(void)( (!!(bIsRunning)) || (_wassert(L"bIsRunning", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(132)), 0) );

	bool bHasYielded			= false;
	if ( bIsRunning )
	{
		bHasYielded = PlatformThread::YieldExecution();
		(void)( (!!(bHasYielded)) || (_wassert(L"bHasYielded", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(138)), 0) );
	}
...
CoreThread::Join( const uint64 uTime /*  = 0 */) noexcept
{
	...
	(void)( (!!(bIsJoinable)) || (_wassert(L"bIsJoinable", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(155)), 0) );
...
CoreThread::Detach() noexcept
{
	...
	(void)( (!!(bIsDetachable)) || (_wassert(L"bIsDetachable", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(192)), 0) );
...
CoreThread::Kill() noexcept
{
	...
	(void)( (!!(bIsValid)) || (_wassert(L"bIsValid", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(212)), 0) );
...
{
	const bool bIsRunning	= IsRunning();
	(void)( (!!(bIsRunning)) || (_wassert(L"bIsRunning", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(227)), 0) );
	
	bool bIsSuspended		= false;
	if ( bIsRunning )
	{
		bIsSuspended		= PlatformThread::Suspend( m_pPlatformThread );
		(void)( (!!(bIsSuspended)) || (_wassert(L"bIsSuspended", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(233)), 0) );
...
CoreThread::Resume() noexcept
{
	...
	(void)( (!!(bIsSuspended)) || (_wassert(L"bIsSuspended", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(248)), 0) );
	
	bool bIsResumed			= false;
	if ( bIsSuspended )
	{
		bIsResumed		= PlatformThread::Resume( m_pPlatformThread );
		(void)( (!!(bIsResumed)) || (_wassert(L"bIsResumed", L"C:\\Users\\dino.bojadjievski\\source\\repos\\Electricity2\\Electricity2\\Thread.cpp", (unsigned)(254)), 0) );
